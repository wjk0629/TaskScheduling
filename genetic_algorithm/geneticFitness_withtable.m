function [output_set] = geneticFitness_withtable(nRobot,numTaskPerStep,tMax,taskSet,robotTaskSeq_set,pop_size,gridMap,taskXY,stationXY)
load('mapGeneration');
output_set = [];
tStep = 0;
bSize = 1;
...
for population = 1:pop_size-1
    ...
    pop_forDisp = population;
    if mod(pop_forDisp,5) == 0
...
fprintf(' best output_set -> bundle : %f \n',max(output_set(1,:)))
